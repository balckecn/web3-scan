...
const { timestampToTime } = require('../../components/web3/Timeutils.js');
...
async function getDevTransferEvent(tx) {
    // if (tx.hash == "0x2e2d75cbd07d822fcc4237f5f8ba3429033f1516ef4125bc0760457dbe73337a" ) {
    //     console.log(tx);
    // }
...
async function checkDevTransferEvent(tx) {
    ...
    if (arr.length > 0) {
        for (let j = 0; j < arr.length; j++) {
            dict.delete(arr[j]);
            //dict.get(arr[j]).isSendScanner = true;
        }
    }
}
